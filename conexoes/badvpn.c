...
// Template para o nome do ficheiro de PID, agora específico por porta
...
// Armazena o caminho completo para o ficheiro PID
...
int main(int argc, char** argv) {
    ...
    // Configura o caminho do ficheiro PID e o syslog
    ...
    // Regista a função de limpeza para ser chamada na saída
    atexit(cleanup);
    ...
    while (1) {
        ...
        if (child_pid == 0) {
            ...
            if (WIFSIGNALED(status)) {
                syslog(LOG_INFO, "Processo filho terminado por sinal. A encerrar o wrapper.");
                break; 
            }
