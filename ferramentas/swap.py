...
def gerenciar_swap():
    """Menu para gerenciar a memória SWAP."""
    while True:
        print("\n--- Gerenciar Memória SWAP ---")
        print("1. Configurar/Ativar SWAP")
        print("2. Desativar/Remover SWAP")
        print("0. Voltar")
        ...
        if choice == '1':
            try:
                size = input("Digite o tamanho do SWAP (ex: 1.5G, 2048M): ") or '1.5G'
                setup_swap(swap_size=size)
